...
<script>
    ...
    $(function () {
        ...
        var left=$("div#carousel-of-product").offset().left;//轮播图的左边距
        $("div.categoryMenu").css("left",left);

//        $("div.categoryWithCarousel div.head").css("left",left);
...
<div class="categoryWithCarousel">
    <div class="show1" style="width: 100%;background-color: #DD2727">
        <div class="headbar">
            <div class="head">
